...
For each reference, extract and return a JSON array containing objects structured exactly like this:
{
  ...
  "pages": "Pages (e.g. '157--166' with double dash for ranges) or null",
...
${bibliographyText}`;
  ...
  console.log(`[${pdfFilename}] Calling OpenRouter minimax/minimax-m3...`);
...
async function main() {
  ...
  console.log("Starting parallel runs for all 5 papers...");
  ...
  console.log("\n=========================================");
  console.log("OVERALL 5-PAPER SUMMARY STATS");
  console.log("=========================================");
